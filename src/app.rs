...
use crate::vulkan_context::{VulkanContext, VulkanSettings};
...
impl HelloTriangleApp {
    pub fn new(window_size: PhysicalSize<u32>) -> HelloTriangleApp {
        ...
        let vulkan_settings = VulkanSettings::new(false);
        let vulkan_context = VulkanContext::new(&window, &vulkan_settings);
